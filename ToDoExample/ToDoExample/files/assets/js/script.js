...
$('#styleSelector').append('' +
    ...
    '<ul>' +
        '<li>' +
            '<a href="http://ableproadmin.com/7.0/default/builder.php" class="btn btn-danger btn-block m-t-10 waves-effect waves-light">Live Page Builder</a>' +
            '<div class="row">' +
                '<div class="col-6">' +
                    '<a href="https://themeforest.net/user/phoenixcoded" class="btn btn-success btn-block m-t-10 m-b-10 waves-effect waves-light">Profile</a>' +
                '</div>' +
                '<div class="col-6">' +
                    '<a href="http://ableproadmin.com/doc-7.0/" target="_blank" class="btn btn-primary btn-block m-t-10 m-b-10 waves-effect waves-light">Documentation</a>' +
                '</div>' +
            '</div>' +
        '</li>' +
